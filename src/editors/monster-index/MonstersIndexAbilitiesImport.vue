...
export default Vue.extend({
  name: "MonstersIndexAbilitiesImport",
  props: {},
  components: {},
  data: () => ({
  ...
  methods: {
    ...
    lineToAbilityLearnable(line: string): {
      monsterId: string;
      type: string;
      abilityId: string;
      level: number;
      ...
      const monsterId = content[0].trim();
      const type = content[1].trim();
      const name = content[2].trim();
